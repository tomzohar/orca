...
describe('createSaveArtifactTool', () => {
    ...
    it('should be defined', () => {
        const tool = createSaveArtifactTool(jobId, mockArtifactStorage, mockEventCallback);
    ...
    it('should save artifact and call event callback', async () => {
        ...
        expect(mockArtifactStorage.store).toHaveBeenCalledWith(jobId, filename, content);
